...
%%盲审版
%\documentclass[degree=master,classlevel=open,mathfont=mathptmx,dedication=false,chapbib=false,finish=peerreview,driver=xetex]{buptgraduatethesis}
...
\include{ch_intro}
\include{ch_concln}
\include{ch_architecture}
\include{ch_implement}
\include{ch_test}
